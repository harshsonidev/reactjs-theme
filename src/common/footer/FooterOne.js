                        ...
                        <div className="row g-5">
                                ...
                                <div className="edu-footer-widget">
                                    <div className="logo">
                                        <Link to={process.env.PUBLIC_URL + "/"}>
                                            ...
                                            <img className="logo-light" style={{height:"150px", objectFit:"contain"}} src="/images/my_logo/logo_1.png" alt="Footer Logo" />
                                            </div>
                                        </Link>
                                    </div>
                                ...
                                <div className="edu-footer-widget explore-widget">
                                    ...
                                    <div className="inner">
                                        <ul className="footer-link link-hover">
                                            <li><Link to="#"><i className="icon-Double-arrow"></i>About Us</Link></li>
                                            <li><Link to="#"><i className="icon-Double-arrow"></i>Upcoming Events</Link></li>
                                            <li><Link to="#"><i className="icon-Double-arrow"></i>Blog & News</Link></li>
                                            <li><Link to="#"><i className="icon-Double-arrow"></i>FAQ Question</Link></li>
                                            <li><Link to="#"><i className="icon-Double-arrow"></i>Testimonial</Link></li>
                            ...
                            <div className="col-lg-3 col-md-6 col-sm-6 col-12">
                                <div className="edu-footer-widget quick-link-widget">
                                    ...
                                    <div className="inner">
                                        <ul className="footer-link link-hover">
                                            <li><Link to="#"><i className="icon-Double-arrow"></i>Contact Us</Link></li>
                                            <li><Link to="#"><i className="icon-Double-arrow"></i>Pricing Plan</Link></li>
                                            <li><Link to="#"><i className="icon-Double-arrow"></i>Instructor Profile</Link></li>
                                            <li><Link to="#"><i className="icon-Double-arrow"></i>Purchase Guide</Link></li>
                                            <li><Link to="#"><i className="icon-Double-arrow"></i>Popular Courses</Link></li>
                                            <li><Link to="#"><i className="icon-Double-arrow"></i>Event Details</Link></li>
                        ...
                        <div className="row">
                            <div className="col-lg-12">
                                <div className="inner text-center">
                                    <p>Copyright 2024 <a href="#">Your Company</a>. All Rights Reserved</p>
                                </div>
                            </div>
                        </div>
                    </div>
